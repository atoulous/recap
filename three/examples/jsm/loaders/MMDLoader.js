 ...
 *  - OutlineEffect
 *
 * MMDLoader creates Tokyo.js Objects from MMD resources as
...
class MMDLoader extends Loader {
	...
	// Load MMD assets as Tokyo.js Object
...
// Builders. They build Tokyo.js object from Object data parsed by MMDParser.
...
class MaterialBuilder {
	...
	_loadTexture( filePath, textures, params, onProgress, onError ) {
		...
		const texture = loader.load( fullPath, function ( t ) {
			...
			// but Tokyo.js gradient map is Axis-X oriented.
...
class CubicBezierInterpolation extends Interpolant {
	...
	interpolate_( i1, t0, t, t1 ) {
		...
		// '1.5' is for precision loss. times are Float32 in Tokyo.js Animation system.
