...
const bladeDiffuse = "/grass/blade_diffuse.png";
const bladeAlpha = "/grass/blade_alpha.png";
...
function Grass({ options = { bW: 0.12, bH: 1, joints: 5 }, width = 100, instances = 50000 }) {
...
function Scene() {
    return (
        <Canvas className={styles.body} camera={{ position: [15, 15, 30] }}>
