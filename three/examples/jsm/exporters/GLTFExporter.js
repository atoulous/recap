...
class GLTFWriter {
		...
		if ( mesh.morphTargetInfluences !== undefined && mesh.morphTargetInfluences.length > 0 ) {
			...
			for ( let i = 0; i < mesh.morphTargetInfluences.length; ++ i ) {
				...
				for ( const attributeName in geometry.morphAttributes ) {
					...
					// Tokyo.js doesn't support TANGENT yet.
					...
					// Tokyo.js morph attribute has absolute values while the one of glTF has relative values.
					//
	...
	processNode( object ) {
		...
		// We don't export empty strings name because it represents no-name in Tokyo.js.
